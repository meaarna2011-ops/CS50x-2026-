...
This repository documents my journey through Harvard's CS50x: Introduction to Computer Science course.

Throughout this course, I am building my foundation in computer science by learning how to think computationally, solve problems, write efficient programs, and understand how technology works behind the scenes.

This repository contains my problem sets, notes, explanations, and reflections on what I learned from each challenge.

---

## My Goals

Through CS50x, I aim to:

- Develop strong programming fundamentals
- Improve my problem-solving and logical thinking skills
- Understand how computer science concepts apply to real-world projects
- Build confidence creating software independently
- Document my growth as a programmer
...
- Challenges I faced
- Concepts I learned
- How I improved my solution

---

## About CS50x

CS50x is Harvard University's introduction to computer science. The course teaches programming fundamentals, algorithms, data structures, and computational thinking through hands-on projects.
